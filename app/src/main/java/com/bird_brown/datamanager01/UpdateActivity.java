...
public class UpdateActivity extends Activity implements View.OnClickListener {
    ...
    private EditText updateNameEdit;    //名前入寮用EditText
    ...
    private boolean updateRecord() {
        ...
        boolean judge = database.update("Products", value, condition, null) != -1 ? true : false;
